...
def scrape_google_maps(log_func, country, state, company_type):
    ...
    with sync_playwright() as p:
        ...
        possible_selectors = [
            ...
            '.Nv2PK',  # class sometimes used in Google Maps listings
            '.section-result',  # old Google Maps UI
            'div.section-result-content',  # old UI
        ]
...
class App:
    def __init__(self, root):
        self.root = root
        root.title("Google Maps Scraper with Auto Selector")
